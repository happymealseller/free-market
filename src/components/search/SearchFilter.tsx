...
const SearchFilter = ({ searchOptions, updateSearchOptions }) => {
    ...
    const handleRadioOptionsChange = (
        ...
        switch (event.target.value) {
            case SortOptions.DATE_LATEST:
                setSelectedOptions({
                    ...selectedOptions,
                    orderByDate: OrderDirection.DESCENDING,
                });
            ...
            case SortOptions.DATE_OLDEST:
                setSelectedOptions({
                    ...selectedOptions,
                    orderByDate: OrderDirection.ASCENDING,
                });
            ...
            case SortOptions.PRICE_LOWEST:
                setSelectedOptions({
                    ...selectedOptions,
                    orderByPrice: OrderDirection.ASCENDING,
                });
            ...
            case SortOptions.PRICE_HIGHEST:
                setSelectedOptions({
                    ...selectedOptions,
                    orderByPrice: OrderDirection.DESCENDING,
                });
    ...
    return (
        <div className="sticky left-20 top-24 pr-10">
            <div className="flex items-baseline justify-between gap-2">
                <h1 className="text-nowrap text-2xl">Filter by</h1>
                <button
            ...
            <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="sortByDate">
                    ...
                    <AccordionContent>
                        <RadioGroup
                            defaultValue=""
                            value={radioDateSortOption}
                            onChange={handleRadioOptionsChange}
                        >
                            {generateRadioCircle(
                                "Latest First",
                                SortOptions.DATE_LATEST,
                                radioDateSortOption
                            )}
                            {generateRadioCircle(
                                "Oldest First",
                                SortOptions.DATE_OLDEST,
                                radioDateSortOption
                            )}
                        </RadioGroup>
                    </AccordionContent>
                ...
                <AccordionItem value="sortByPrice">
                    ...
                    <AccordionContent>
                        <RadioGroup
                            defaultValue=""
                            value={radioPriceSortOption}
                            onChange={handleRadioOptionsChange}
                        >
                            {generateRadioCircle(
                                "Price Low to High",
                                SortOptions.PRICE_LOWEST,
                                radioPriceSortOption
                            )}
                            {generateRadioCircle(
                                "Price High to Low",
                                SortOptions.PRICE_HIGHEST,
                                radioPriceSortOption
                            )}
                        </RadioGroup>
                    </AccordionContent>
                    ...
                    <AccordionContent>
                        <div className="flex flex-col space-y-2">
                            <div className="flex items-center justify-start">
                                <label className="w-10" htmlFor="min">
                                    Min
                                </label>
                                <input
                                    className="w-3/4 rounded border border-slate-400 px-1"
                                    id="min"
                            ...
                            <div className="flex items-center justify-start">
                                <label className="w-10" htmlFor="max">
                                    Max
                                </label>
                                <input
                                    className="w-3/4 rounded border border-slate-400 px-1"
                ...
                <AccordionItem value="condition">
                    ...
                    <AccordionContent>
                        <RadioGroup
                            defaultValue=""
                            value={radioConditionOption}
                            onChange={handleRadioOptionsChange}
                        >
                            {generateRadioCircle(
                                "New",
                                ListingCondition.NEW,
                                radioConditionOption
                            )}
                            {generateRadioCircle(
                                "Like New",
